...
public class SmsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        smobile = view.findViewById(R.id.rfname);
        stitle = view.findViewById(R.id.rlname);
        sdes = view.findViewById(R.id.remail);
        squantity = view.findViewById(R.id.rpassword);
        sprice = view.findViewById(R.id.rcpassword);
        btnsendsms = view.findViewById(R.id.btnReg);
