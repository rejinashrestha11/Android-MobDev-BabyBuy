...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //For input value
        Efname = findViewById(R.id.rfname);
        Elname = findViewById(R.id.rlname);
        Eemail = findViewById(R.id.remail);
        Epassword = findViewById(R.id.rpassword);
        Ecpassword = findViewById(R.id.rcpassword);


        //For Registration and Login redirection Button
        rbtn = findViewById(R.id.btnReg);
        redirecttologin = findViewById(R.id.rlog);
