...
import com.example.babybuy.Adapter.ListCatAdapter;
...
public class CatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        catadapter = new ListCatAdapter(getContext(), catdata());
    ...
    private ArrayList<CatDataModel> catdata() {
        BabyBuyDb catdb = new BabyBuyDb(getActivity());
    ...
    private void addnewcategorydailoge() {
        ...
        addcat.setPositiveButton("add", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                BabyBuyDb db_cat = new BabyBuyDb(getActivity());
                ...
                if (insertCat == -1) {
                    ...
                    ListCatAdapter adapter = new ListCatAdapter(getContext(), catdata());
