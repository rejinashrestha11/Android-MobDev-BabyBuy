...
public class ManageProdAdapter extends RecyclerView.Adapter<ManageProdAdapter.ViewHolder> {

    Context context;
    ArrayList<ProductDataModel> arrayList;

    public ManageProdAdapter(Context context, ArrayList<ProductDataModel> arrayList) {
    ...
    @NonNull
    @Override
    public ManageProdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.design_product_recyclerview, parent, false);
        ManageProdAdapter.ViewHolder viewHolder = new ManageProdAdapter.ViewHolder(v);
        return viewHolder;
    }
