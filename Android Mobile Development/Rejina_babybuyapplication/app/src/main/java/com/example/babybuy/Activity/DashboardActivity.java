...
import com.example.babybuy.Fragments.ChartFragment;
import com.example.babybuy.Fragments.SmsFragment;
import com.example.babybuy.Fragments.UserFragment;
import com.example.babybuy.Fragments.CatFragment;
import com.example.babybuy.Fragments.ManageProdFragment;
...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_babybuyhome);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(this.getResources().getColor(R.color.followersBg));
        }
        ...
        toggle.getDrawerArrowDrawable().setColor(getResources().getColor(R.color.followers));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.mproduct: {
                        loadFragment(new ManageProdFragment());
                        break;
                    }
