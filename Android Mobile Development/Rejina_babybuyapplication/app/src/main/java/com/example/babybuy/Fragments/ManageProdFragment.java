...
import com.example.babybuy.Adapter.ManageProdAdapter;
...
public class ManageProdFragment extends Fragment {

    public ManageProdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       try{
           ...
           if (i == 1) {
               ...
               ManageProdAdapter adapter = new ManageProdAdapter(getActivity(), alldata);
