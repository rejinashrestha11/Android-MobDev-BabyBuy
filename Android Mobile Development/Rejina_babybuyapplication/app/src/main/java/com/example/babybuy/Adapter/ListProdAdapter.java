...
import com.example.babybuy.Activity.ListProdActivity;
...
public class ListProdAdapter extends RecyclerView.Adapter<ListProdAdapter.ViewHolder> {

    Context context;
    ArrayList<ProductDataModel> arrayList;


    public ListProdAdapter(Context context, ArrayList<ProductDataModel> arrayList) {
    ...
    @NonNull
    @Override
    public ListProdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.design_product_recyclerview, parent, false);
        ListProdAdapter.ViewHolder viewHolder = new ListProdAdapter.ViewHolder(v);
        return viewHolder;
    }
        ...
        holder.productstatuscheckbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (holder.productstatuscheckbox.isChecked()) {
                    ...
                    BabyBuyDb db = new BabyBuyDb(context);
                    db.productpurchased(productstsvalue, pdm.getProductid());
                    if (context instanceof ListProdActivity) {
                        ListProdActivity activity = (ListProdActivity) context;
